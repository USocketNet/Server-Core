...
<span class="cstat-no" title="statement not covered" >                request.put({url:templateURL,json:indexTemplate}, function (error, response, body) <span class="fstat-no" title="function not covered" >{</span></span>
