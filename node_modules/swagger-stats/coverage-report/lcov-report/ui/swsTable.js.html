...
<html lang="en">
<head>
    <title>Code coverage report for ui\swsTable.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ui/</a> swsTable.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( args &amp;&amp; 'dataTableSettings' in args ) {
...
&nbsp;
    SWSTable.prototype.rowadd = function (data) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if('row' in data) {
