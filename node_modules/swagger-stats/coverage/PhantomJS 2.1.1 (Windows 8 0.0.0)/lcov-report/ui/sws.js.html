...
<html lang="en">
<head>
    <title>Code coverage report for ui\sws.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ui/</a> sws.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">91.02% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>659/724</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">66.55% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>197/296</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>650/694</span>
      </div>
    </div>
  </div>
...
1444
1445
1446</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
    ...
    var pluginTemplates = {
        ...
        footer:'&lt;footer class="sws-footer bd-footer text-muted"&gt; \
                    &lt;div class="container-fluid"&gt; \
                        ...
                        &lt;p&gt;&lt;a href="http://swaggerstats.io" target="_blank"&gt;&lt;strong&gt; swagger-stats v.0.95.0&lt;/strong&gt;&lt;/a&gt;&lt;/p&gt; \
...
&nbsp;
        ...
        this.swsBasePath = 'swsBasePath' in options ? <span class="branch-0 cbranch-no" title="branch not covered" >options.swsBasePath </span>: null;
&nbsp;
        // TODO Stats
&nbsp;
...
&nbsp;
    ...
    SWSUI.prototype.renderCol = function( page, row, col, elemCol ) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!('type' in col)) <span class="cstat-no" title="statement not covered" >return;</span>
        switch(col.type){
            case 'empty':
                break;
            case 'title':
...
&nbsp;
        $(window).on('hashchange', function(e) {
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if(that.loggingIn){
<span class="cstat-no" title="statement not covered" >                if(window.location.hash !== loginLocHash ){</span>
<span class="cstat-no" title="statement not covered" >                    window.location.hash = loginLocHash;</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
            }else{
                <span class="missing-if-branch" title="if path not taken" >I</span>if(window.location.hash === loginLocHash ){
<span class="cstat-no" title="statement not covered" >                    window.location.hash = '#'+that.layout.startpage;</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
            }
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if( hashLoc !== ''){
<span class="cstat-no" title="statement not covered" >            console.log('Starting at: ' + hashLoc );</span>
<span class="cstat-no" title="statement not covered" >            this.setActive(hashLoc);</span>
        }else{
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if( hasharray.length &gt; 1){
<span class="cstat-no" title="statement not covered" >            this.activePageId = hasharray[0].replace('#','');</span>
<span class="cstat-no" title="statement not covered" >            this.activePageContext = hasharray[1];</span>
        }else{
...
&nbsp;
        // Fallback to default
        <span class="missing-if-branch" title="if path not taken" >I</span>if( !(this.activePageId in this.layout.pages) ){
<span class="cstat-no" title="statement not covered" >            this.activePageId = this.layout.startpage;</span>
        }
&nbsp;
...
&nbsp;
&nbsp;
    SWSUI.prototype.remove = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >		this.destroy();</span>
<span class="cstat-no" title="statement not covered" >		$.removeData(this, pluginName);</span>
	};
&nbsp;
...
&nbsp;
    SWSUI.prototype.pauseOrResumeRefresh = function () {
        <span class="missing-if-branch" title="else path not taken" >E</span>if( this.refreshIntervalId != null ){
            clearInterval(this.refreshIntervalId);
            this.refreshIntervalId = null;
            return false;
        }
<span class="cstat-no" title="statement not covered" >        this.refreshIntervalId = setInterval( $.proxy(this.refreshStats, this), this.refreshInterval*1000 );</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(this.swsBasePath !== null ) {
<span class="cstat-no" title="statement not covered" >            getdataURL = this.swsBasePath + '/' + getdataDef.url;</span>
        }
        var getdataReq = { type: getdataDef.type, url:getdataURL , data:{} };
        getdataReq.data.fields = [];
        // Support fields to be retrieved always
        <span class="missing-if-branch" title="else path not taken" >E</span>if(('data' in getdataDef) &amp;&amp; ('fields' in getdataDef.data) &amp;&amp; (getdataDef.data.fields instanceof Array)){
        ...
        if('getfieldsonce' in activeDef){
            for(var i=0;i&lt;activeDef.getfieldsonce.length;i++){
                <span class="missing-if-branch" title="if path not taken" >I</span>if( !(activeDef.getfieldsonce[i] in this.apistats) ){
<span class="cstat-no" title="statement not covered" >                    getdataReq.data.fields.push(activeDef.getfieldsonce[i]);</span>
                }
            }
        }
&nbsp;
...
&nbsp;
        ...
        if( (this.loginUsername!=='') &amp;&amp; (this.loginPassword!=='')){
            <span class="missing-if-branch" title="else path not taken" >E</span>if(!('headers' in getdataReq)){
                getdataReq.headers = {};
            }
...
&nbsp;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if( (xswsauth !== undefined) &amp;&amp; xswsauth &amp;&amp; (xswsauth=='true') ){
...
&nbsp;
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if(jqXHR.status===403){
                    that.loggingIn = true;
...
&nbsp;
    SWSUI.prototype.updateTimeControls = function(datatype) {
        ...
        $('.sws-time-from').html(this.apistats.startts!==null ? moment(this.apistats.startts).format(this.shortDateTimeFormat) : <span class="branch-1 cbranch-no" title="branch not covered" >'-')</span>;
        $('.sws-uptime').html(this.apistats.startts!==null ? moment(this.apistats.startts).fromNow() : <span class="branch-1 cbranch-no" title="branch not covered" >'-')</span>;
...
&nbsp;
        ...
        if( 'timeline' in data ){
            ...
            this.timeline_array = [];
            <span class="missing-if-branch" title="else path not taken" >E</span>if(this.apistats &amp;&amp; this.apistats.timeline &amp;&amp; this.apistats.timeline.data ) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(this.swsBasePath !== null ) {
<span class="cstat-no" title="statement not covered" >            getdataURL = this.swsBasePath + '/logout';</span>
        }
...
&nbsp;
        ...
        $.ajax( getdataReq )
            ...
            .fail(<span class="fstat-no" title="function not covered" >function( jqXHR, textStatus ){</span>
            });
    };
&nbsp;
&nbsp;
    SWSUI.prototype.onRefreshClick = function(Event){
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!Event.target) <span class="cstat-no" title="statement not covered" >return;</span>
        ...
        if(interval==0){
            ...
            $(Event.target).addClass( this.pauseOrResumeRefresh() ? <span class="branch-0 cbranch-no" title="branch not covered" >'fa-pause':</span>'fa-play');
            return;
        }
...
&nbsp;
    SWSUI.prototype.onChangeAPIOp = <span class="fstat-no" title="function not covered" >function(srcEvent){</span>
<span class="cstat-no" title="statement not covered" >        console.log('onChangeAPIOp');</span>
<span class="cstat-no" title="statement not covered" >        var selectedOp = {};</span>
<span class="cstat-no" title="statement not covered" >        $('#sws_apiop_opsel').swsapiopsel('getvalue', selectedOp);</span>
<span class="cstat-no" title="statement not covered" >        var locHash = '#sws_apiop='+selectedOp.method+','+selectedOp.path;</span>
<span class="cstat-no" title="statement not covered" >        window.location.hash = locHash;</span>
    };
&nbsp;
    // SERVICE //////////////////////////////////////////// //
&nbsp;
    ...
    SWSUI.prototype.getLatestTimelineValue = function(key, prop) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(this.apistats==null) <span class="cstat-no" title="statement not covered" >return 0;</span>
        try {
            var last = this.apistats.timeline.data[this.apistats.timeline.settings.bucket_current];
            return ((key in last) &amp;&amp; (prop in last[key])? last[key][prop] : <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>;
        }catch(e){
...
&nbsp;
    ...
    SWSUI.prototype.getTimelineTrend = function (key, prop){
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!this.timeline_array || this.timeline_array.length&lt;=0) <span class="cstat-no" title="statement not covered" >return '';</span>
        <span class="missing-if-branch" title="if path not taken" >I</span>if( !(key in this.timeline_array[0]) || !(prop in this.timeline_array[0][key])) <span class="cstat-no" title="statement not covered" >return '';</span>
        ...
        for(var i=0;i&lt;n;i++) {
            ...
            var x = ((key in entry) &amp;&amp; (prop in entry[key]) ? entry[key][prop] : <span class="branch-1 cbranch-no" title="branch not covered" >0)</span>;
            sum_x += x;
            sum_y += i;
            sum_xy += (x*i);
            sum_xx += (x*x);
        ...
        var res = (slope &gt; 0 ? 'up' : (slope&lt;0 ? <span class="branch-0 cbranch-no" title="branch not covered" >'down':</span> '') );
        return res;
    };
&nbsp;
    ...
    SWSUI.prototype.formatWValDurationMS = function(data,fixed){
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!('value' in data)) <span class="cstat-no" title="statement not covered" >return data;</span>
        fixed = typeof fixed !== 'undefined' ? fixed : 0;
        var val = data.value;
        <span class="missing-if-branch" title="else path not taken" >E</span>if(val &lt;1000){
            data.value = val.toFixed(fixed);
            data.extra = 'msec';
        }else{
<span class="cstat-no" title="statement not covered" >            data.value = (val/1000).toFixed(fixed);</span>
<span class="cstat-no" title="statement not covered" >            data.extra = 'sec';</span>
        }
        return data;
    };
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            chartdata.labels.shift();</span>
<span class="cstat-no" title="statement not covered" >            for(var ks=0;ks&lt;datasets.length;ks++){</span>
<span class="cstat-no" title="statement not covered" >                chartdata.datasets[ks].data.shift();</span>
            }
        }
        // Update
        var j = 0;
    ...
    SWSUI.prototype.updateByMethodChartData = function(chartdata,prop,adjust) {
        ...
        for (var method in this.apistats.method) {
            ...
            if(vGetter){
                ...
                val = (adjust ? <span class="branch-0 cbranch-no" title="branch not covered" >adjust(vRaw) </span>: vRaw);
            }else{
                val = prop in reqStats ? (adjust ? adjust(reqStats[prop]) : reqStats[prop]) : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (idx != -1) {
<span class="cstat-no" title="statement not covered" >                chartdata.datasets[0].data[idx] = val;</span>
            } else {
                idx = chartdata.labels.length;
                chartdata.labels.push(method);
                chartdata.datasets[0].data.push(val);
                <span class="missing-if-branch" title="if path not taken" >I</span>if (idx &gt;= this.palette2.length) <span class="cstat-no" title="statement not covered" >idx = idx % this.palette2.length;</span>
...
&nbsp;
    ...
    SWSUI.prototype.formatBytes = function(a,b){
        <span class="missing-if-branch" title="if path not taken" >I</span>if(0==a) <span class="cstat-no" title="statement not covered" >return"0 Bytes";</span>
        var c=1e3,d=b||<span class="branch-1 cbranch-no" title="branch not covered" >2,</span>e=["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"],f=Math.floor(Math.log(a)/Math.log(c));
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(this.apistats==null) <span class="cstat-no" title="statement not covered" >return;</span>
        var that = this;
&nbsp;
        // Update Widgets
...
&nbsp;
    ...
    SWSUI.prototype.updateErrors = function() {
        // Update values, if we have data
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!this.apistats || !this.apistats.errors) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
        // Table
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if(this.apistats.errors.statuscode) {
...
&nbsp;
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if(idx!=-1){
<span class="cstat-no" title="statement not covered" >                    chartData.datasets[0].data[idx] = codeCount;</span>
                }else{
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if(this.apistats.errors.topnotfound) {
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if(this.apistats.errors.topservererror) {
...
&nbsp;
    ...
    SWSUI.prototype.updateLastErrors = function() {
        // Update values, if we have data
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!this.apistats || !this.apistats.lasterrors) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
        var elemErrTable = $('#sws_lerr_tErr');
        elemErrTable.swstable('clear');
        <span class="missing-if-branch" title="else path not taken" >E</span>if(this.apistats.lasterrors &amp;&amp; this.apistats.lasterrors.length&gt;0) {
...
&nbsp;
    ...
    SWSUI.prototype.updateLongestReq = function() {
        // Update values, if we have data
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!this.apistats || !this.apistats.longestreq) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
        var elemLReqTable = $('#sws_lreq_tReq');
        elemLReqTable.swstable('clear');
        <span class="missing-if-branch" title="else path not taken" >E</span>if(this.apistats.longestreq &amp;&amp; this.apistats.longestreq.length&gt;0) {
...
&nbsp;
        ...
        for(var path in this.apistats.apistats){
            ...
            for( var method in apiPath) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if( ('apidefs' in this.apistats) &amp;&amp; (path in this.apistats.apidefs) &amp;&amp; (method in this.apistats.apidefs[path]) ){
                    apiOpDef = this.apistats.apidefs[path][method];
                }
                var row = [ '', path, method,
                    ('swagger' in apiOpDef ? (apiOpDef.swagger ? 'Yes':<span class="branch-1 cbranch-no" title="branch not covered" >'No')</span>: <span class="branch-1 cbranch-no" title="branch not covered" >'No')</span>,
                    ('deprecated' in apiOpDef ? (apiOpDef.deprecated ? 'Yes':''): <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>,
                    apiOpStats.requests,
                    ...
                    ('operationId' in apiOpDef ? apiOpDef.operationId : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>,
                    ('summary' in apiOpDef ? apiOpDef.summary : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>,
                    ('description' in apiOpDef ? apiOpDef.description : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>,
                    ('tags' in apiOpDef ? apiOpDef.tags.join(',') : <span class="branch-1 cbranch-no" title="branch not covered" >'')</span>
                ];
...
&nbsp;
    ...
    SWSUI.prototype.switchToAPIOp = <span class="fstat-no" title="function not covered" >function(method,path) {</span>
<span class="cstat-no" title="statement not covered" >        var locHash = '#sws_apiop=' + method + ',' + path;</span>
<span class="cstat-no" title="statement not covered" >        window.location.hash = locHash;</span>
    };
&nbsp;
    // Update values on API page
...
&nbsp;
        var opStats = null;
        var opDetails = null;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( ('apiop' in this.apistats) &amp;&amp; (selectedOp.path in this.apistats.apiop) &amp;&amp; (selectedOp.method in this.apistats.apiop[selectedOp.path]) ){
            <span class="missing-if-branch" title="else path not taken" >E</span>if('stats' in this.apistats.apiop[selectedOp.path][selectedOp.method]) {
                opStats = this.apistats.apiop[selectedOp.path][selectedOp.method].stats;
            }
            <span class="missing-if-branch" title="else path not taken" >E</span>if('details' in this.apistats.apiop[selectedOp.path][selectedOp.method]) {
                opDetails = this.apistats.apiop[selectedOp.path][selectedOp.method].details;
            }
        }
        <span class="missing-if-branch" title="if path not taken" >I</span>if(opStats==null) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
        // Update Widgets
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if(opDetails==null) <span class="cstat-no" title="statement not covered" >return;</span>
&nbsp;
        // Update Charts +++
        <span class="missing-if-branch" title="else path not taken" >E</span>if( ('duration' in opDetails) &amp;&amp; ('buckets' in opDetails.duration) &amp;&amp; ('values' in opDetails.duration) ){
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( ('req_size' in opDetails) &amp;&amp; ('buckets' in opDetails.req_size) &amp;&amp; ('values' in opDetails.req_size) ){
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( ('res_size' in opDetails) &amp;&amp; ('buckets' in opDetails.res_size) &amp;&amp; ('values' in opDetails.res_size) ){
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'code' in opDetails ){
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if(opDetails.parameters ) {
            for(var paramname in opDetails.parameters ){
                var param = opDetails.parameters[paramname];
                var row = ['',
                    'name' in param ? param.name : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
                    'in' in param ? param.in : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
                    'hits' in param ? param.hits : <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
                    'misses' in param ? param.misses : <span class="branch-1 cbranch-no" title="branch not covered" >0,</span>
                    'type' in param ? <span class="branch-0 cbranch-no" title="branch not covered" >param.type </span>: '',
                    'format' in param ? <span class="branch-0 cbranch-no" title="branch not covered" >param.format </span>: '',
                    'required' in param ? param.required : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
                    'description' in param ? param.description : <span class="branch-1 cbranch-no" title="branch not covered" >'',</span>
...
&nbsp;
            <span class="missing-if-branch" title="if path not taken" >I</span>if (idx != -1) {
<span class="cstat-no" title="statement not covered" >                chartdata.datasets[0].data[idx] = value;</span>
            } else {
                idx = chartdata.labels.length;
...
&nbsp;
            ...
            var bucket = code;
            var value = 'count' in codeobj ? codeobj.count : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
&nbsp;
...
&nbsp;
    SWSUI.prototype.getAPIOpInfoMarkup = function(path,method) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if( ('apidefs' in this.apistats) &amp;&amp; (path in this.apistats.apidefs) &amp;&amp; (method in this.apistats.apidefs[path]) ){
            ...
            var isSwagger = 'No';
            <span class="missing-if-branch" title="else path not taken" >E</span>if( ('swagger' in apiOpDef) &amp;&amp; apiOpDef.swagger  ) isSwagger = 'Yes';
            markup += this.getInfoRowMarkup('Swagger',isSwagger);
            <span class="missing-if-branch" title="if path not taken" >I</span>if( ('deprecated' in apiOpDef) &amp;&amp; apiOpDef.deprecated ) {
<span class="cstat-no" title="statement not covered" >                markup += this.getInfoRowMarkup('Deprecated','Yes');</span>
            }
            <span class="missing-if-branch" title="else path not taken" >E</span>if('operationId' in apiOpDef) markup += this.getInfoRowMarkup('operationId',apiOpDef.operationId);
            <span class="missing-if-branch" title="else path not taken" >E</span>if('summary' in apiOpDef) markup += this.getInfoRowMarkup('Summary',apiOpDef.summary);
            <span class="missing-if-branch" title="else path not taken" >E</span>if('description' in apiOpDef) markup += this.getInfoRowMarkup('Description',apiOpDef.description);
            <span class="missing-if-branch" title="else path not taken" >E</span>if('tags' in apiOpDef) markup += this.getInfoRowMarkup('Tags',apiOpDef.tags.join(','));
        }else{
<span class="cstat-no" title="statement not covered" >            markup += this.getInfoRowMarkup('Swagger','No');</span>
        }
        markup += '&lt;/div&gt;';
        return markup;
    };
...
<span class="cstat-no" title="statement not covered" >				if (!_this) {</span>
<span class="cstat-no" title="statement not covered" >					logError('Not initialized, can not call method : ' + options);</span>
				}
				else <span class="cstat-no" title="statement not covered" >if (!$.isFunction(_this[options]) || options.charAt(0) === '_') {</span>
<span class="cstat-no" title="statement not covered" >					logError('No such method : ' + options);</span>
				}
				else {
...
<span class="cstat-no" title="statement not covered" >					result = _this[options].apply(_this, args);</span>
				}
			}
			else <span class="missing-if-branch" title="if path not taken" >I</span>if (typeof options === 'boolean') {
<span class="cstat-no" title="statement not covered" >				result = _this;</span>
			}
			else {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Mon Apr 30 2018 23:09:51 GMT-0700 (Pacific Daylight Time)
</div>
</div>
