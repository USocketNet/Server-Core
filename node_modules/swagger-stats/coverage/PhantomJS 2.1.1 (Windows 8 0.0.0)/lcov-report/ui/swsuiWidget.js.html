...
<html lang="en">
<head>
    <title>Code coverage report for ui\swsuiWidget.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ui/</a> swsuiWidget.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        var value = typeof data.value !== 'undefined' ? data.value : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
...
&nbsp;
        ...
        elemTrend.empty();
        if((trend!=null) &amp;&amp; (trend!='')){
            elemTrend.append($('&lt;i class="fa"&gt;').addClass(trend=='up' ? 'fa-chevron-circle-up' : <span class="branch-1 cbranch-no" title="branch not covered" >'fa-chevron-circle-down')</span>);
