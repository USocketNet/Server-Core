...
<html lang="en">
<head>
    <title>Code coverage report for ui\swsuiChart.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ui/</a> swsuiChart.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    SWSChart.prototype.init = function (options, args ) {
		...
		<span class="missing-if-branch" title="else path not taken" >E</span>if( args &amp;&amp; 'chartdata' in args ) {
            this.chartdata = args.chartdata;
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if( args  &amp;&amp; 'chartoptions' in args  ) {
...
&nbsp;
    SWSChart.prototype.render = function () {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if(('title' in this.options) &amp;&amp; (this.options.title!=='')) {
            elemChart.find('h5').html(this.options.title);
        }else{
<span class="cstat-no" title="statement not covered" >            elemChart.find('h5').remove();</span>
        }
