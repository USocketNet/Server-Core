...
<html lang="en">
<head>
    <title>Code coverage report for ui\swsLayout.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">ui/</a> swsLayout.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>109/115</span>
      </div>
    </div>
  </div>
...
1080
1081
1082</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
                            ...
                            dataTableSettings:{
                                ...
                                columns: [
                                    ...
                                    {title:'Processing',render:function( data, type, full, meta ) {
                                        <span class="missing-if-branch" title="if path not taken" >I</span>if(data&gt;0) <span class="cstat-no" title="statement not covered" >return '&lt;span class="badge badge-table badge-warning"&gt;'+data+'&lt;/span&gt;';</span>
                                        return data;
                                    }},
                                    ...
                                    {title:'Apdex Score', render:function( data, type, full, meta ) {
                                        <span class="missing-if-branch" title="else path not taken" >E</span>if(data&lt;0.5) return '&lt;span class="badge badge-table badge-warning"&gt;'+data+'&lt;/span&gt;';
                            ...
                            dataTableSettings:{
                                ...
                                columns: [
                                    {title:'Status Code', render:function( data, type, full, meta ) {
                                        <span class="missing-if-branch" title="else path not taken" >E</span>if(data&gt;0) return '&lt;span class="badge badge-table badge-danger"&gt;'+data+'&lt;/span&gt;';
<span class="cstat-no" title="statement not covered" >                                        return data;</span>
                                    }},
                                    {title:'Reason-Phrase'},
                        ...
                        sws_err_cCode  : {
                            ...
                            chartoptions : {
                                ...
                                legend: { display: false },
                                animation: { animateScale: true, animateRotate: true },
                                tooltips: { callbacks: { title: <span class="fstat-no" title="function not covered" >function(ttItem,data){</span>
<span class="cstat-no" title="statement not covered" >                                    var xLabel = ttItem[0].xLabel;</span>
<span class="cstat-no" title="statement not covered" >                                    var extLabel = (xLabel in $.swsui.httpStatusCodes ? $.swsui.httpStatusCodes[xLabel] : '');</span>
<span class="cstat-no" title="statement not covered" >                                    return xLabel + ' ' + extLabel;</span>
                                }} }
                            }
                        }
                    }
...
<span class="cstat-no" title="statement not covered" >                                        return data;</span>
                            ...
                            showDetails: function(row){
                                ...
                                var detailsContent = '';
                                var rData = row.data();
                                <span class="missing-if-branch" title="else path not taken" >E</span>if(row.data()[4] == 'Yes'){
                                    detailsContent = '&lt;strong&gt;DEPRECATED&lt;/strong&gt;&lt;br/&gt;';
                                    alertClass = 'alert-danger';
                                }
                                detailsContent += row.data()[19] != '' ? '&lt;strong&gt;operationId: &lt;/strong&gt;'+ row.data()[19] +'&lt;br/&gt;' : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
                                detailsContent += row.data()[20] != '' ? '&lt;strong&gt;Summary: &lt;/strong&gt;'+ row.data()[20] +'&lt;br/&gt;' : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
                                detailsContent += row.data()[21] != '' ? '&lt;strong&gt;Description: &lt;/strong&gt;'+ row.data()[21] +'&lt;br/&gt;': <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
                                detailsContent += row.data()[22] != '' ? '&lt;strong&gt;Tags: &lt;/strong&gt;'+ row.data()[22] : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
        ...
        var page = {
            ...
            getdataproc: function(pageId, pageCtx, getDataReq){
                ...
                if((pageId=="sws_apiop") &amp;&amp; (pageCtx != null)){
                    ...
                    <span class="missing-if-branch" title="else path not taken" >E</span>if(vals.length==2){
                            ...
                            dataTableSettings:{
                                ...
                                columns: [
                                    ...
                                    {title:'Hits', render:function( data, type, full, meta ) {
                                        <span class="missing-if-branch" title="if path not taken" >I</span>if(data&gt;0) <span class="cstat-no" title="statement not covered" >return '&lt;span class="badge badge-table badge-info"&gt;'+data+'&lt;/span&gt;';</span>
                                        return data;
                                    }},
                                    {title:'Misses', render:function( data, type, full, meta ) {
                                        <span class="missing-if-branch" title="if path not taken" >I</span>if(data&gt;0) <span class="cstat-no" title="statement not covered" >return '&lt;span class="badge badge-table badge-danger"&gt;'+data+'&lt;/span&gt;';</span>
                                        return data;
                                    }},
