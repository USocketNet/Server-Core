...
<html lang="en">
<head>
    <title>Code coverage report for swsUtil.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> swsUtil.js
    </h1>
    <div class='clearfix'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">25.49% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>13/51</span>
      </div>
    </div>
  </div>
...
module.exports.getStatusCodeClass = <span class="fstat-no" title="function not covered" >fu</span>nction (code) {
<span class="cstat-no" title="statement not covered" >    if (code &lt; 200) <span class="cstat-no" title="statement not covered" >return "info";</span></span>
<span class="cstat-no" title="statement not covered" >    if (code &lt; 300) <span class="cstat-no" title="statement not covered" >return "success";</span></span>
<span class="cstat-no" title="statement not covered" >    if (code &lt; 400) <span class="cstat-no" title="statement not covered" >return "redirect";</span></span>
<span class="cstat-no" title="statement not covered" >    if (code &lt; 500) <span class="cstat-no" title="statement not covered" >return "client_error";</span></span>
<span class="cstat-no" title="statement not covered" >    return "server_error";</span>
};
&nbsp;
module.exports.isError = <span class="fstat-no" title="function not covered" >fu</span>nction (code) {
<span class="cstat-no" title="statement not covered" >    return (code &gt;= 400);</span>
};
&nbsp;
...
module.exports.swsStringRecursive = <span class="fstat-no" title="function not covered" >fu</span>nction (output, val) {
...
<span class="cstat-no" title="statement not covered" >            output[key] = this.swsStringRecursive(output[key], val[key]);</span>
        }
    } else {
<span class="cstat-no" title="statement not covered" >        output = this.swsStringValue(val);</span>
    }
&nbsp;
...
module.exports.swsCastStringR = <span class="fstat-no" title="function not covered" >fu</span>nction (val) {
<span class="cstat-no" title="statement not covered" >    switch( typeof val ){</span>
        case "string": <span class="cstat-no" title="statement not covered" >return val;</span>
        case "boolean":
        case "number":
<span class="cstat-no" title="statement not covered" >            return val.toString();</span>
        case "object":
            var casted = <span class="cstat-no" title="statement not covered" >{};</span>
<span class="cstat-no" title="statement not covered" >            for(var prop in val){</span>
<span class="cstat-no" title="statement not covered" >                casted[prop] = module.exports.swsCastStringR(val[prop]);</span>
            }
<span class="cstat-no" title="statement not covered" >            return casted;</span>
    }
<span class="cstat-no" title="statement not covered" >    return '';</span>
};
&nbsp;
&nbsp;
// returns string value of argument, depending on typeof
module.exports.swsNumValue = <span class="fstat-no" title="function not covered" >fu</span>nction (val) {
    var res = <span class="cstat-no" title="statement not covered" >Number(val);</span>
<span class="cstat-no" title="statement not covered" >    return Number.isNaN(res) ? 0: res;</span>
};
&nbsp;
// Calculate CPU Usage Percentage
module.exports.swsCPUUsagePct = <span class="fstat-no" title="function not covered" >fu</span>nction(starthrtime, startusage) {
    // On CPU - see
    // https://github.com/nodejs/node/pull/6157
    var elapTime = <span class="cstat-no" title="statement not covered" >process.hrtime(starthrtime);</span>
    const NS_PER_SEC = <span class="cstat-no" title="statement not covered" >1e9;</span>
    var elapsedns = <span class="cstat-no" title="statement not covered" >elapTime[0] * NS_PER_SEC + elapTime[1];</span> // nanoseconds
    var elapsedmcs = <span class="cstat-no" title="statement not covered" >elapsedns/1000;</span>    // microseconds
    var elapUsage = <span class="cstat-no" title="statement not covered" >process.cpuUsage(startusage);</span> // microseconds
    var cpuPercent = (<span class="cstat-no" title="statement not covered" >100 * (elapUsage.user + elapUsage.system) / elapsedmcs </span>);
