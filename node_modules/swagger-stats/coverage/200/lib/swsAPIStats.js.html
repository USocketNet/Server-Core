  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>240/261</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">71.34% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>117/164</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>220/231</span>
      </div>
    </div>
  </div>
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if( (typeof path === 'undefined') || !path || (path==='')) <span class="cstat-no" title="statement not covered" >return {};</span>
    <span class="missing-if-branch" title="if path not taken" >I</span>if( (typeof method === 'undefined') || !method || (method==='')) <span class="cstat-no" title="statement not covered" >return {};</span>
&nbsp;
    var res = {};
    res[path] = {};
    res[path][method] = {};
&nbsp;
    // api op defs
    <span class="missing-if-branch" title="else path not taken" >E</span>if( (path in this.apidefs) &amp;&amp; (method in this.apidefs[path])) {
        res[path][method].defs = this.apidefs[path][method];
    }
&nbsp;
    // api op stats
    <span class="missing-if-branch" title="else path not taken" >E</span>if( (path in this.apistats) &amp;&amp; (method in this.apistats[path])) {
        res[path][method].stats = this.apistats[path][method];
    }
&nbsp;
    // api op details
    <span class="missing-if-branch" title="else path not taken" >E</span>if( (path in this.apidetails) &amp;&amp; (method in this.apidetails[path])) {
...
swsAPIStats.prototype.extractPathParams = function (matchResult,keys) {
    ...
    for(var i=0;i&lt;keys.length;i++){
        <span class="missing-if-branch" title="else path not taken" >E</span>if('name' in keys[i] ) {
            var vidx = i + 1; // first element in match result is URI
            <span class="missing-if-branch" title="else path not taken" >E</span>if( vidx &lt; matchResult.length ) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if( matchEntry ) {
&nbsp;
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'in' in param ){
            switch(param.in){
                case "path":
                    <span class="missing-if-branch" title="else path not taken" >E</span>if(('path_params' in req.sws) &amp;&amp; (pname in req.sws.path_params)) {
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Mon Apr 30 2018 23:08:50 GMT-0700 (Pacific Daylight Time)
</div>
</div>
