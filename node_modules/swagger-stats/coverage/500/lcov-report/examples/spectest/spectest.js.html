...
<html lang="en">
<head>
    <title>Code coverage report for examples/spectest/spectest.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">examples/spectest</a> spectest.js
    </h1>
    <div class='clearfix'>
...
app.disable('etag');
&nbsp;
app.get('/', <span class="fstat-no" title="function not covered" >fu</span>nction(req,res) {
<span class="cstat-no" title="statement not covered" >    res.redirect('/swagger-stats/ui');</span>
});
&nbsp;
// Return Prometheus metrics from prom-client
app.get('/metrics', <span class="fstat-no" title="function not covered" >fu</span>nction(req,res) {
...
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if( process.env.SWS_SPECTEST_URL ){
    specLocation = process.env.SWS_SPECTEST_URL;
}
&nbsp;
var tlBucket = 60000;
<span class="missing-if-branch" title="if path not taken" >I</span>if( process.env.SWS_SPECTEST_TIMEBUCKET ){
<span class="cstat-no" title="statement not covered" >    tlBucket = parseInt(process.env.SWS_SPECTEST_TIMEBUCKET);</span>
}
&nbsp;
...
&nbsp;
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if( process.env.SWS_ELASTIC ){
