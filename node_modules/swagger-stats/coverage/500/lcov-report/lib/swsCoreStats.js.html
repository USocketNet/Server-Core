...
<html lang="en">
<head>
    <title>Code coverage report for lib/swsCoreStats.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\index.html">All files</a> / <a href="index.html">lib</a> swsCoreStats.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    this.sys.rss = 'rss' in memUsage ? memUsage.rss : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    this.sys.heapTotal = 'heapTotal' in memUsage ? memUsage.heapTotal : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    this.sys.heapUsed = 'heapUsed' in memUsage ? memUsage.heapUsed : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
    this.sys.external = 'external' in memUsage ? memUsage.external : <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
&nbsp;
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(method in this.method)) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if ("_contentLength" in res){
...
&nbsp;
    ...
    var method = req.method;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (method in this.method) {
...
&nbsp;
    ...
    switch(codeclass){
        case "success":
            ...
            break;
<span class="branch-1 cbranch-no" title="branch not covered" >        case "redirect":</span>
            // NOOP //
<span class="cstat-no" title="statement not covered" >            break;</span>
<span class="branch-2 cbranch-no" title="branch not covered" >        case "client_error":</span>
...
<span class="cstat-no" title="statement not covered" >            break;</span>
<span class="branch-3 cbranch-no" title="branch not covered" >        case "server_error":</span>
<span class="cstat-no" title="statement not covered" >            this.promClientMetrics.api_all_errors_total.inc();</span>
