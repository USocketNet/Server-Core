...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if( codeclass=="success" ) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (duration &lt;= this.apdex_threshold) {
<span class="cstat-no" title="statement not covered" >            this.apdex_satisfied++;</span>
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (duration &lt;= (this.apdex_threshold * 4)) {
