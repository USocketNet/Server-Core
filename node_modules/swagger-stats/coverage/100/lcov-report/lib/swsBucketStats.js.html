...
<html lang="en">
<head>
    <title>Code coverage report for lib/swsBucketStats.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\index.html">All files</a> / <a href="index.html">lib</a> swsBucketStats.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1479x</span>
<span class="cline-any cline-yes">1479x</span>
<span class="cline-any cline-yes">16269x</span>
<span class="cline-any cline-yes">1479x</span>
<span class="cline-any cline-yes">1479x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof buckets === "object" ){
        <span class="missing-if-branch" title="else path not taken" >E</span>if( Array.isArray(buckets)){
...
swsBucketStats.prototype.countValue = function(value) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if(!valuePlaced) <span class="cstat-no" title="statement not covered" >this.values[this.values.length - 1]++;</span>
};
&nbsp;
