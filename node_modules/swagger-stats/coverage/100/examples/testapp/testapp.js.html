...
<html lang="en">
<head>
    <title>Code coverage report for examples/testapp/testapp.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\..\index.html">All files</a> / <a href="index.html">examples/testapp</a> testapp.js
    </h1>
    <div class='clearfix'>
...
<span class="cstat-no" title="statement not covered" >    res.redirect('/ui');</span>
});
&nbsp;
app.get('/apidoc.json', <span class="fstat-no" title="function not covered" >fu</span>nction(req,res){
<span class="cstat-no" title="statement not covered" >    res.setHeader('Content-Type', 'application/json');</span>
<span class="cstat-no" title="statement not covered" >    res.send(swaggerSpec);</span>
});
&nbsp;
var tlBucket = 60000;
<span class="missing-if-branch" title="else path not taken" >E</span>if( process.env.SWS_TEST_TIMEBUCKET ){
...
&nbsp;
        ...
        app.get('/stats', <span class="fstat-no" title="function not covered" >fu</span>nction(req,res){
<span class="cstat-no" title="statement not covered" >            res.setHeader('Content-Type', 'application/json');</span>
<span class="cstat-no" title="statement not covered" >            res.send(swStats.getCoreStats());</span>
        });
&nbsp;
