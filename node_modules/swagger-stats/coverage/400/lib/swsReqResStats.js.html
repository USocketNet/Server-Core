...
<html lang="en">
<head>
    <title>Code coverage report for lib/swsReqResStats.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="..\index.html">All files</a> / <a href="index.html">lib</a> swsReqResStats.js
    </h1>
    <div class='clearfix'>
...
function swsReqResStats(apdex_threshold) {
    ...
    this.apdex_threshold = typeof apdex_threshold !== 'undefined' ? apdex_threshold : <span class="branch-1 cbranch-no" title="branch not covered" >50;</span>   // Apdex threshold
...
swsReqResStats.prototype.countRequest = function(clength) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.max_req_clength &lt; clength) <span class="cstat-no" title="statement not covered" >this.max_req_clength = clength;</span>
...
swsReqResStats.prototype.countResponse = function(code,codeclass,duration,clength) {
    this.responses++;
    this[codeclass]++;
    <span class="missing-if-branch" title="if path not taken" >I</span>if( swsUtil.isError(code) ) <span class="cstat-no" title="statement not covered" >this.errors++;</span>
    this.total_time += duration;
    this.avg_time = this.total_time / this.requests;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.max_time &lt; duration) this.max_time = duration;
    this.total_res_clength += clength;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (this.max_res_clength &lt; clength) this.max_res_clength = clength;
    this.avg_res_clength = Math.floor(this.total_res_clength / this.responses);
&nbsp;
    // Apdex: https://en.wikipedia.org/wiki/Apdex
    <span class="missing-if-branch" title="else path not taken" >E</span>if( codeclass=="success" ) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (duration &lt;= this.apdex_threshold) {
