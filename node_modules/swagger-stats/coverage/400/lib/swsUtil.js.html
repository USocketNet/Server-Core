...
module.exports.getStatusCodeClass = function (code) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (code &lt; 300) return "success";
...
module.exports.swsStringRecursive = function (output, val) {
    <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof val === "object" &amp;&amp; !Array.isArray(val)) {
        for (var key in val) {
