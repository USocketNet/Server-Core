  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>112/131</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">86.82% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>112/129</span>
      </div>
    </div>
  </div>
...
&nbsp;
        if( (authInfo !== undefined) &amp;&amp; (authInfo!==null) &amp;&amp; ('name' in authInfo) &amp;&amp; ('pass' in authInfo)){
            <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof swsOptions.onAuthenticate === 'function'){
&nbsp;
...
&nbsp;
    // Check session cookie
    var sessionIdCookie = cookies.get('sws-session-id');
    <span class="missing-if-branch" title="else path not taken" >E</span>if( (sessionIdCookie !== undefined) &amp;&amp; (sessionIdCookie !== null) ){
        <span class="missing-if-branch" title="else path not taken" >E</span>if( sessionIdCookie in sessionIDs ){
...
&nbsp;
    processAuth(req,res).then(function (authResult){
        ...
        res.status(200);
        <span class="missing-if-branch" title="else path not taken" >E</span>if(('sws-auth' in req) &amp;&amp; req['sws-auth']){
