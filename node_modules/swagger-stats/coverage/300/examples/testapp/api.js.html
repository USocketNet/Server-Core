 ...
 */
apirouter.get('/success', <span class="fstat-no" title="function not covered" >fu</span>nction (req, res) {
 ...
 */
apirouter.get('/redirect', <span class="fstat-no" title="function not covered" >fu</span>nction (req, res) {
<span class="cstat-no" title="statement not covered" >    res.redirect('/api/v1/success');</span>
});
&nbsp;
/**
 * @swagger
 ...
 */
apirouter.get('/client_error', <span class="fstat-no" title="function not covered" >fu</span>nction (req, res) {
 ...
 */
apirouter.get('/server_error', <span class="fstat-no" title="function not covered" >fu</span>nction (req, res) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >testerImpl(</span>req, res) {
    var code = <span class="cstat-no" title="statement not covered" >500;</span>
    var message = <span class="cstat-no" title="statement not covered" >"ERROR: Wrong parameters";</span>
<span class="cstat-no" title="statement not covered" >    if(('params' in req) &amp;&amp; 'code' in req.params ){</span>
<span class="cstat-no" title="statement not covered" >        code = parseInt(req.params.code);</span>
<span class="cstat-no" title="statement not covered" >        message = "Request Method:" + req.method +', params.code: ' + req.params.code;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if(('query' in req) &amp;&amp; ('delay' in req.query)){</span>
        var delay = <span class="cstat-no" title="statement not covered" >parseInt(req.query.delay);</span>
...
<span class="cstat-no" title="statement not covered" >            res.status(code).json({code: code, message: message});</span>
        },delay);
    }else {
<span class="cstat-no" title="statement not covered" >        res.status(code).json({code: code, message: message});</span>
    }
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if(typeof hdrSwsRes !== 'undefined'){
        var swsRes = JSON.parse(hdrSwsRes);
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'code' in swsRes ) code = swsRes.code;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'message' in swsRes ) message = swsRes.message;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'delay' in swsRes ) delay = swsRes.delay;
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'payloadsize' in swsRes ) payloadsize = swsRes.payloadsize;
    }
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if( delay &gt; 0 ){
        setTimeout(function(){
...
function mockApiSendResponse(res,code,message,payloadsize){
    <span class="missing-if-branch" title="if path not taken" >I</span>if(payloadsize&lt;=0){
<span class="cstat-no" title="statement not covered" >        res.status(code).send(message);</span>
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(adjSize&lt;=0) <span class="cstat-no" title="statement not covered" >adjSize = 1;</span>
        var str = '';
