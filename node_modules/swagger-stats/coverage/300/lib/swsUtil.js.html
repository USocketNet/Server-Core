...
module.exports.getStatusCodeClass = function (code) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (code &lt; 500) return "client_error";
...
module.exports.swsStringValue = function (val) {
    switch( typeof val ){
<span class="branch-0 cbranch-no" title="branch not covered" >        case "string": <span class="cstat-no" title="statement not covered" >return val;</span></span>
<span class="branch-1 cbranch-no" title="branch not covered" >        case "boolean":</span>
<span class="branch-2 cbranch-no" title="branch not covered" >        case "number":</span>
<span class="cstat-no" title="statement not covered" >            return val.toString();</span>
        case "object":
            <span class="missing-if-branch" title="if path not taken" >I</span>if(val === null) <span class="cstat-no" title="statement not covered" >return '';</span>
            var res = '';
            try {
