        ...
        <div class="content">
            ...
            <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                ...
                <td class="content-block">
                    ...
                    echo sprintf( esc_html__( 'New suggestion for doc `%s`', 'docupress' ), esc_html( get_the_title( $data['post'] ) ) );
                    ?>
                </td>
                </tr>
            </table>
                        ...
                        <td>
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="field-row"><tbody>
                                <tr><td class="field-row-label">
                                    <strong>
                                        <?php echo esc_html__( 'From', 'docupress' ); ?>
                                    </strong>
                                </td></tr>
                                <tr><td class="field-row-value">
                                    ...
                                    echo sprintf( esc_html__( '%1$s (IP: %2$s)', 'docupress' ), esc_html( $data['from'] ), esc_html( $data['ip_address'] ) );
                                    ?>
                                </td></tr>
                            </tbody></table>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="field-row"><tbody>
                                <tr><td class="field-row-label">
                                    <strong>
                                        <?php echo esc_html__( 'Helpful?', 'docupress' ); ?>
                                    </strong>
                                </td></tr>
                                <tr><td class="field-row-value field-helpful-type-<?php echo esc_attr( $data['feedback_type'] ); ?>">
                                    <?php
                                    echo 'negative' === $data['feedback_type'] ? esc_html__( 'Negative', 'docupress' ) : esc_html__( 'Positive', 'docupress' );
                                    ?>
                                </td></tr>
                            </tbody></table>
                            ...
                            <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="field-row"><tbody>
                                <tr><td class="field-row-label">
                                    <strong>
                                        <?php echo esc_html__( 'Suggestion', 'docupress' ); ?>
                                    </strong>
                                </td></tr>
                                <tr><td class="field-row-value">
                                    <?php
                ...
                <td class="content-block">
                    ...
                    echo wp_kses_post(
                        sprintf(
                            ...
                            __( 'This e-mail was sent from a suggestion form on %1$s. (%2$s)', 'docupress' ),
