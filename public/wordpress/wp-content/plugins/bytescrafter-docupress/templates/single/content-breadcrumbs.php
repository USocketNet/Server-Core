 ...
 *
 * This template can be overridden by copying it to yourtheme/docupress/single/content-breadcrumbs.php.
 *
 * @author  nK
...
// phpcs:ignore
$breadcrumbs = docupress()->get_breadcrumbs_array();
?>

<ul class="docupress-single-breadcrumbs" itemscope itemtype="http://schema.org/BreadcrumbList">
