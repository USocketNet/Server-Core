 ...
 *
 * This template can be overridden by copying it to yourtheme/docupress/single/footer.php.
 *
 * @author  nK
...
<footer class="entry-footer">
    ...
    <time itemprop="dateModified" datetime="<?php echo esc_attr( get_the_modified_date( 'c' ) ); ?>">
        ...
        printf( esc_html__( 'Last modified %s', 'docupress' ), esc_html( get_the_modified_date() ) );
        ?>
    </time>
</footer>
