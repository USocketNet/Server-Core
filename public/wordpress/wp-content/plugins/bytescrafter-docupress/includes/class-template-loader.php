 ...
 * Template Loader
 *
 * @class       DocuPress_Template_Loader
 * @package     docupress
 */
class DocuPress_Template_Loader {
    /**
    ...
    public static function init() {
        self::$docs_archive_id = docupress()->get_option( 'docs_page_id', 'docupress_settings', false );
     ...
     *
     * Templates are in the 'templates' folder. docupress looks for theme.
     * overrides in /theme/docupress/ by default.
     *
    ...
    public static function template_loader( $template ) {
        ...
        if ( $default_file ) {
            /**
             * Filter hook to choose which files to find before DocuPress does it's own logic.
             *
             * @var array
             */
            ...
            if ( ! $template ) {
                $template = docupress()->template_path . $default_file;
            }
        }
    ...
    private static function get_template_loader_files( $default_file ) {
        $search_files = apply_filters( 'docupress_template_loader_files', array(), $default_file );

        if ( is_page_template() ) {
            $search_files[] = get_page_template_slug();
        }

        $search_files[] = '/docupress/' . $default_file;
        return array_unique( $search_files );
    }
}

DocuPress_Template_Loader::init();
