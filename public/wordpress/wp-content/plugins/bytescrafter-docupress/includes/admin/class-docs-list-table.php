 ...
 */
class DocuPress_Docs_List_Table {
    /**
     * Construct
     */
    ...
    public function add_meta_box() {
        add_meta_box( 'op-menu-meta-box-id', __( 'Helpfulness', 'docupress' ), array( $this, 'helpfulness_metabox' ), 'docs', 'side', 'core' );
    }
    ...
    public function helpfulness_css() {
        ...
        ?>
        <style type="text/css">
            .docupress-helpfulness-form {
                display: flex;
                flex-wrap: wrap;
            }
            .docupress-helpfulness-form > div {
                display: flex;
                flex: 1;
                align-items: center;
            }
            .docupress-helpfulness-form input[type="number"] {
                width: 45px;
                margin-left: 10px;
                text-align: center;
            }
            .docupress-helpfulness-form .docupress-positive {
                color: green;
            }
            .docupress-helpfulness-form .docupress-negative {
                color: red;
    ...
    public function helpfulness_metabox() {
        ...
        ?>
        <div class="docupress-helpfulness-form">
            <div class="docupress-positive">
    ...
    public function docs_list_columns( $columns ) {
        $vote = array( 'votes' => __( 'Votes', 'docupress' ) );
    ...
    public function docs_list_columns_row( $column_name, $post_id ) {
        if ( 'votes' === $column_name ) {
            ...
            printf( '<span class="docupress-positive">%d</span>/<span class="docupress-negative">%d</span>', esc_html( $positive ), esc_html( $negative ) );
        }
    }
