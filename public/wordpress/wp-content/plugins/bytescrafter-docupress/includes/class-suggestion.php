...
class DocuPress_Suggestion {
    ...
    public static function process_mail( $data ) {
        if ( isset( $data['from'] ) && ! empty( $data['from'] ) ) {
            ...
            $from = esc_html__( 'Anonymous', 'docupress' );
        }
        ...
        $email_to = docupress()->get_option( 'show_feedback_suggestion_email', 'docupress_single', '' ) ? docupress()->get_option( 'show_feedback_suggestion_email', 'docupress_single', '' ) : get_option( 'admin_email' );

        // translators: %s - blog name.
        $subject = sprintf( esc_html__( '[%s] New Doc Suggestion', 'docupress' ), $data['blogname'] );
