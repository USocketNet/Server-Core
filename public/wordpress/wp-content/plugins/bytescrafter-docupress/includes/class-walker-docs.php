...
/**
 * DocuPress Docs Walker
 */
class DocuPress_Walker_Docs extends Walker_Page {
    /**
     * Parent doc.
     *
     * @var mixed
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
        ...
        $show_number_childrens = isset( $args['pages_with_children'][ $page->ID ] ) && docupress()->get_option( 'sidebar_show_nav_number_of_childs', 'docupress_single', true );
