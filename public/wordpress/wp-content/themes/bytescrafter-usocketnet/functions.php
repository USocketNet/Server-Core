...
<?php
    ...
    {    
        ...
        wp_enqueue_script('usn_jquery_js', get_template_directory_uri() . '/assets/js/jquery.js', array(),'1.11.1', false);
        wp_enqueue_script('usn_bootstrap_js', get_template_directory_uri() . '/assets/bootstrap/js/bootstrap.min.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_jqstellar_js', get_template_directory_uri() . '/assets/js/jquery.stellar.min.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_jqsticky_js', get_template_directory_uri() . '/assets/js/jquery.sticky.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_jqscroll_js', get_template_directory_uri() . '/assets/js/smoothscroll.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_jqwow_js', get_template_directory_uri() . '/assets/js/wow.min.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_jqcounto_js', get_template_directory_uri() . '/assets/js/jquery.countTo.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_inview_js', get_template_directory_uri() . '/assets/js/jquery.inview.min.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_easypie_js', get_template_directory_uri() . '/assets/js/jquery.easypiechart.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_shuffle_js', get_template_directory_uri() . '/assets/js/jquery.shuffle.min.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_magnific_js', get_template_directory_uri() . '/assets/js/jquery.magnific-popup.min.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_fitvids_js', get_template_directory_uri() . '/assets/js/jquery.fitvids.js', array(),'3.3.2', false);
        wp_enqueue_script('usn_script_js', get_template_directory_uri() . '/assets/js/theme.js', array(),'3.3.2', false);
